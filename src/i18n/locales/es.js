export default {
  ...
  "guide": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "<kbd>?</kbd> abre la guía completa. <kbd>ℹ️</kbd> explicación del modo activo. <kbd>📊</kbd> panel Investigación.\n\n<kbd>R</kbd> reinicia todo. <kbd>Espacio</kbd> pausa/reanuda. <kbd>V</kbd> vista limpia (solo 3D). Arrastra = rotar, rueda = zoom. <kbd>+</kbd>/<kbd>-</kbd> acercar/alejar. <kbd>H</kbd> zoom al horizonte. <kbd>D</kbd> zoom al disco. <kbd>0</kbd> vista lejana.\n\nPanel derecho (lil-gui): Escena, Agujero negro, Cosmología, Horizonte, Simulación (zoom), Laboratorio, <strong>Investigación</strong>, Binario, Reset.\n\n<strong>Paneles izquierda:</strong> HUD + Laboratorio + Teoría (columna apilada, scroll si hace falta). <strong>Investigación</strong> abajo-derecha. <strong>Universo vivo</strong> abajo-centro (colapsado por defecto)."
      }
    ]
  },
  "explainer": {
    ...
    "modes": {
      ...
      "gargantua": {
        ...
        "physics": "<strong>Base física:</strong> Kerr con <strong>rₛ = 2GM/c²</strong>, spin visual <strong>0,6</strong> (como en pantalla en Interestelar; Thorne/Double Negative), ISCO Kerr ≈ <strong>1,91 rₛ</strong>, disco desde ~<strong>2 rₛ</strong>, esfera de fotones pedagógica a <strong>1,5 rₛ</strong> (Schwarzschild). <strong>Lensing:</strong> post-proceso en pantalla (no ray-tracing DNGR). Masa visual <strong>55 M☉</strong> por escala del simulador; Gargantua real ≈ <strong>10⁸ M☉</strong>. La dilatación extrema de Miller requiere spin casi extremal — no reproducida aquí.",
  ...
  "gui": {
    ...
    "zoomHorizon": "🔭 Zoom al horizonte",
    "zoomDisk": "💿 Zoom al disco",
    "zoomWide": "↔ Vista lejana",
    "tour": "▶ Tour 60s",
    "lab": "Laboratorio",
