export default {
  ...
  "explainer": {
    ...
    "modes": {
      ...
      "gargantua": {
        ...
        "physics": "<strong>Physics basis:</strong> Kerr with <strong>rₛ = 2GM/c²</strong>, visual spin <strong>0.6</strong> (on-screen Interstellar value per Thorne/Double Negative), Kerr ISCO ≈ <strong>1.91 rₛ</strong>, disk from ~<strong>2 rₛ</strong>, pedagogical photon sphere at <strong>1.5 rₛ</strong> (Schwarzschild). <strong>Lensing:</strong> screen-space post-process (not DNGR ray-tracing). Visual mass <strong>55 M☉</strong> for simulator scale; real Gargantua ≈ <strong>10⁸ M☉</strong>. Miller's extreme time dilation needs near-extremal spin — not reproduced here.",
  ...
  "panels": {
    ...
    "theory": {
      ...
      "binary": {
        "title": "Binary black hole merger",
        "short": "Two black holes spiraling in via gravitational waves (Peters, 1964). Reduced mass μ, chirp mass ℳ.",
        "desc": "On merger, ~5% of mass is radiated. Ringdown and optional Hawking evaporation. Includes accretion bridge, orbit trails and coalescence animation. <em>Disclaimer:</em> inspiral validated with Peters; merger/ringdown are phenomenological.",
