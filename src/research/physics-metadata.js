...
export const PHYSICS_METADATA = {
  ...
  hawking_mass_loss_rate: {
    ...
    equation: '|dM/dt| = ℏc⁴/(15360πG²M²)',
    reference: 'Hawking (1974)',
    approximation: 'Schwarzschild; emisión térmica de cuerpo negro',
    validRange: 'M > 0',
    citation: 'Hawking 1974',
  },
  hawking_luminosity: {
    ...
    equation: 'L = c²|dM/dt| = ℏc⁶/(15360πG²M²)',
    reference: 'Hawking (1974)',
    approximation: 'Potencia radiada total; ignora espectro de greybody detallado',
    validRange: 'M > 0',
    citation: 'Hawking 1974',
  },
  hawking_page_time: {
    ...
    name: 'Tiempo de Page',
    equation: 'τ_Page = 512πG²M³/(ℏc⁴) = t_evap/10',
    reference: 'Page (1993)',
    approximation: 'Punto de máxima entropía de radiación; paradoja de la información',
    validRange: 'M > 0',
    citation: 'Page 1993',
  },
  bekenstein_entropy: {
    id: 'bekenstein_entropy',
    name: 'Entropía Bekenstein-Hawking',
    equation: 'S = k_B c³A/(4Gℏ)',
    reference: 'Bekenstein (1973); Hawking (1974)',
    approximation: 'Área del horizonte; satura cota de Bekenstein en Schwarzschild',
    validRange: 'M > 0',
    citation: 'Bekenstein 1973',
  },
  bekenstein_bound: {
    id: 'bekenstein_bound',
    name: 'Cota de Bekenstein',
    equation: 'S ≤ 2πk_B E R/(ℏc)',
    reference: 'Bekenstein (1981)',
    approximation: 'E = Mc², R = rₛ para el agujero simulado',
    validRange: 'E, R > 0',
    citation: 'Bekenstein 1981',
  },
  hawking_information_bits: {
    id: 'hawking_information_bits',
    name: 'Bits informacionales',
    equation: 'N_bits = S/(k_B ln 2)',
    reference: 'Bekenstein-Hawking; Shannon',
    approximation: 'Conteo de microestados del horizonte',
    validRange: 'M > 0',
    citation: 'Bekenstein 1973',
  },
  gw_strain_inspiral: {
...
export const MODE_PHYSICS_METADATA = {
  ...
  binary_merger: {
    name: 'Choque binario',
    validated: ['μ', 'Peters dE/dt', 'T_Hawking', 't_evap', 'L_Hawking', 'τ_Page'],
